...
//ParkingPojo
public class MainMapMainActivity extends AppCompatActivity
...
/*
        ...
        MainMapMainActivity.Fetcher fetcher = new MainMapMainActivity.Fetcher();
        String method = "driverList";
        fetcher.execute(method, lat, lon);
    ...
    private class Fetcher extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            for (int i = 0; i < jsonToPersonList.size(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(MainMapMainActivity.this);
...
*/
                    ...
                    Intent i = new Intent(MainMapMainActivity.this, ViewActivity.class);
