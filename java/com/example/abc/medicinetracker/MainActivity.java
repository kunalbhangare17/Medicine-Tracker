...
import com.example.abc.medicinetracker.util.CustomApplication;


public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener , FragmentReminder.OnFragmentInteractionListener ,        FirstAidTips.OnFragmentInteractionListener,Knowmed.OnFragmentInteractionListener,AboutUs.OnFragmentInteractionListener
        ...
        if(intent.getExtras()!=null)
        {
            if(intent.getExtras().getInt("id")!=0)
            {
              ...
              /*  Home hm = new Home();
               ...
               /* SymtomsFragment rm = new SymtomsFragment();
                getSupportFragmentManager().beginTransaction().replace(R.id.container, rm).commit();
...
*/
            UserReportFragment ht=new UserReportFragment();
        ...
        /*
            ...
            Intent intent=new Intent(MainActivity.this,MainMapMainActivity.class);
